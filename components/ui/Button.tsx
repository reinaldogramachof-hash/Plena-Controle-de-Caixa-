...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-plena-orange text-white hover:bg-orange-700 focus:ring-plena-orange",
    secondary: "bg-black text-white hover:bg-gray-800 focus:ring-black",
    outline: "border-2 border-plena-orange text-plena-orange hover:bg-orange-50",
